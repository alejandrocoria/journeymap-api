...
//		});
    ...
    var autoMapDialog = function () {
        ...
        var dialog = $(messageTemplate)
            ...
            .dialog({
                ...
                buttons: [
                    {
                        width: '80px', text: getMessage('automap_dialog_all'), click: function () {
                            toggleAutoMap('all');
                            $(this).dialog("close");
                        }
                    },
                    {
                        width: '80px', text: getMessage('automap_dialog_missing'), click: function () {
                            toggleAutoMap('missing');
                            $(this).dialog("close");
                        }
                    },
                    {
                        width: '80px', text: getMessage('automap_dialog_none'), click: function () {
                            toggleAutoMap('stop');
                            $(this).dialog("close");
                        }
                    },
                    {
                        width: '80px', text: getMessage('automap_dialog_close'), click: function () {
                            $(this).dialog("close");
                        }
                    }
                ]
    ...
    function setCenterOnPlayer(onPlayer) {
        ...
        var followButtonImg = $("#followButtonImg");
        if (onPlayer) {
            followButtonImg.attr('src', 'img/ico/follow-on.png');
            ...
            followButtonImg.attr('src', 'img/ico/follow-off.png');
        }
