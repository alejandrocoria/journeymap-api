...
public class MiniMapHotkeysHelp extends JmUI {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        drawHelpStrings(Constants.getString("MiniMap.hotkeys_toggle"), Keyboard.getKeyName(Constants.KB_MAP.getKeyCode()), x, y+=12);
        ...
        drawHelpStrings(Constants.getString("MiniMap.hotkeys_position"), Keyboard.getKeyName(Constants.KB_MINIMAP_POS.getKeyCode()), x, y+=12);
