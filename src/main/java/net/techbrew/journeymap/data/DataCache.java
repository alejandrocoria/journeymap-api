...
public class DataCache
{
    ...
    private class DataHolder
    {
        ...
        DataHolder(IDataProvider dp, Map optionalParams)
        {
            ...
            expires = System.currentTimeMillis() + (Math.max(1000, dp.getTTL()));
        }
        ...
        public String getJsonData()
        {
            if (jsonData == null)
            {
                Map tempData = new HashMap(data);
                tempData.remove(EntityKey.entityLiving);
