...
public interface IServerAPI extends IJmAPI
{
     ...
     */
    void setPlayerFeatures(String modId, UUID playerID, int dimension, GameType gameType, Map<Feature, Boolean> featureMap);
     ...
     */
    Map<Feature, Boolean> getPlayerFeatures(UUID playerID, int dimension, GameType gameType);
     ...
     * @return A map of features with booleans indicating whether they are enabled/disabled.
     */
    Map<Feature, Boolean> getServerFeatures(int dimension, GameType gameType);
