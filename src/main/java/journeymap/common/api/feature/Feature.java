...
public interface Feature
{
    ...
    public enum Action implements Feature
    {
        ...
        public boolean getDefaultAllowed(boolean isOp, WorldSettings.GameType gameType)
        {
            switch (this)
            {
     ...
     */
    default boolean getDefaultAllowed(boolean isOp, WorldSettings.GameType gameType)
    {
        return true;
    }
