...
public class FlatTheme extends Theme
{
    ...
    /**
     * Based on http://www.colorcombos.com/color-schemes/301/ColorCombo301.html
     */
    ...
    /**
     * Based on http://colorpalettes.net/color-palette-3011/
     */
    ...
    public static Theme createStronghold()
    {
        ...
        theme.container.toolbar.horizontal.inner.alpha = .5f;
        theme.container.toolbar.horizontal.inner.color = darker;
        theme.container.toolbar.vertical.inner.alpha = .5f;
    ...
    /**
     * Based on http://colorpalettes.net/color-palette-2661/
     */
    ...
    private static Theme createFlatTheme(String themeName, String light, String medium, String dark, String darker, String darkest)
    {
        ...
        style.label.background.alpha = .7f;
        ...
        style.toolbarColorSpec.alpha = .8f;
    ...
    private static Theme.Minimap.MinimapCircle minimapCircle(Style style)
    {
        ...
        minimap.reticleHeading.alpha = .4f;
