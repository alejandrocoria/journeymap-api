...
public class Waypoint implements Serializable
{
    ...
    public Waypoint(String name, int x, int y, int z, boolean enable, int red, int green, int blue, Type type, String origin, Integer currentDimension, Collection<Integer> dimensions)
    {
        ...
        if (dimensions == null || dimensions.size() == 0)
        {
            ...
            dimensions.add(FMLClientHandler.instance().getClient().thePlayer.worldObj.provider.getDimension());
        }
    ...
    public static Waypoint of(EntityPlayer player)
    {
        ...
        return at(blockPos, Type.Normal, FMLClientHandler.instance().getClient().thePlayer.worldObj.provider.getDimension());
    }
    ...
    {
        return dimensions.contains(FMLClientHandler.instance().getClient().thePlayer.worldObj.provider.getDimension());
    }
