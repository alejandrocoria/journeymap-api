...
public class ColorHelper_1_8 // implements IColorHelper
{
    /**
     ...
     @Override public boolean failedFor(BlockMD blockMD)
     {
     return failed.contains(blockMD);
     }

     @Override public int getColorMultiplier(Block block, int x, int y, int z)
     {
     // 1.7
     ...
     @Deprecated
     @Override public int getRenderColor(BlockMD blockMD)
     {
     // 1.7
     ...
     @Override public int getMapColor(BlockMD blockMD)
     {
     // 1.7
     ...
     @Override public Integer getTextureColor(BlockMD blockMD)
     {
     ...
     @Override public boolean initBlocksTexture()
     {
