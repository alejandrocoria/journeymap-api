...
journeymap_api_version = 1.11.2-2.0 // or 1.11.2-2.0-SNAPSHOT
...
1. [Download JourneyMap](http://journeymap.info/Download) 5.2.0b1 or later and place it in your runtime mods directory (usually `/run/mods`).
