...
journeymap_api_version = 1.10.2-2.0 // or 1.10.2-2.0-SNAPSHOT
...
You don't need a "dev" or "deobf" version of JourneyMap; Forge or later now handles automatic deobfuscation for you.
